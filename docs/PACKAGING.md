...
- `dist/legends-yt-dlp-slayer-0.1.0-alpha.zip`
- `dist/legends-yt-dlp-slayer-0.1.0-alpha.zip.sha256`
...
```powershell
tar -tf dist\legends-yt-dlp-slayer-0.1.0-alpha.zip
Get-Content dist\legends-yt-dlp-slayer-0.1.0-alpha.zip.sha256
```
